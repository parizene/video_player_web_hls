...
class VideoPlayerPlugin extends VideoPlayerPlatform {
  ...
  Future<int> createWithOptions(VideoCreationOptions options) async {
    ...
    late String uri;
    Map<String, String>? headers; // HLS: Extract headers from dataSource
    ...
    switch (dataSource.sourceType) {
      case DataSourceType.network:
        ...
        uri = dataSource.uri ?? '';
        headers = dataSource.httpHeaders; // HLS: Preserve headers for HLS authentication
    ...
    final VideoPlayer player = VideoPlayer(videoElement: videoElement)
      ..initialize(src: uri, headers: headers); // HLS: Pass headers to initialize method
